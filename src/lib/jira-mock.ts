...
export const mockIssues: JiraIssue[] = [
  {
    id: "EXT-1042",
    title: "Checkout crashes when applying expired promo code",
    assignee: { name: "Priya Shah", initials: "PS" },
    type: "Bug",
  ...
  {
    id: "EXT-1043",
    title: "As a user, I can export invoices as PDF",
  ...
  {
    id: "EXT-1044",
    title: "Upgrade Node runtime to 22 LTS across services",
    assignee: { name: "Diego Alvarez", initials: "DA" },
    type: "Task",
  ...
  {
    id: "EXT-1045",
    title: "Q3 Billing Platform Overhaul",
    assignee: { name: "Nadia Petrova", initials: "NP" },
    type: "Epic",
  ...
  {
    id: "EXT-1046",
    title: "Fix flaky signup e2e test on Safari",
    assignee: { name: "Marcus Chen", initials: "MC" },
    type: "Bug",
  ...
  {
    id: "EXT-1047",
    title: "Dark mode support for settings panel",
    assignee: { name: "Aisha Okafor", initials: "AO" },
    type: "Story",
  ...
  {
    id: "EXT-1049",
    title: "Webhook retries never back off past 5s",
    assignee: { name: "Priya Shah", initials: "PS" },
    type: "Bug",
  ...
  {
    id: "EXT-1052",
    title: "Document new release procedure in Confluence",
    assignee: { name: "Marcus Chen", initials: "MC" },
    type: "Task",
  ...
  {
    id: "EXT-1053",
    title: "Email notifications sent twice on retry",
    assignee: { name: "Priya Shah", initials: "PS" },
    type: "Bug",
